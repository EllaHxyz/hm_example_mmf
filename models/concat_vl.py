...
@registry.register_model("concat_v1")
class LanguageAndVisionConcat(BaseModel):
    ...
    def build(self):
        ...
        """
        image mapper: 2048 -> 32

        """
        self.image_mapper = torch.nn.Linear(**self.config.image_mapper.params)
        """
        Text encoders
        """
    ...
    def forward(self, sample_list):
        ...
        image_features = self.relu(self.image_mapper(image_features.squeeze(dim=1)))
